...
// Mock getPlaceholder and decorateIcons for deterministic aria-labels
...
// Mock matchMedia and hlx globally
beforeAll(() => {
  ...
  // Mock window.hlx for decorateIcons
  window.hlx = {
    codeBasePath: '',
  };
});
...
describe('Column Carousel', () => {
  ...
  describe('createNavigation', () => {
    it('creates navigation with button elements and proper icons', () => {
      window.innerWidth = 1024;
      ...
      const prevArrow = nav.querySelector('button.agt-link--dark');
      const nextArrow = nav.querySelectorAll('button.agt-link--dark')[1];
      ...
      const prevIcon = prevArrow.querySelector('.icon.icon-chevron-left');
      const nextIcon = nextArrow.querySelector('.icon.icon-chevron-right');
  ...
  describe('showSlide functionality', () => {
    it('updates ARIA attributes correctly when changing slides', () => {
      ...
      const nextButton = block.querySelectorAll('button.agt-link--dark')[1];
      const dots = block.querySelectorAll('.columns__nav-dot');
  ...
  describe('Navigation Functionality', () => {
    it('changes active slide when button arrows are clicked', () => {
      ...
      const slides = block.querySelectorAll('.columns__slide');
      const dots = block.querySelectorAll('.columns__nav-dot');
      const buttons = block.querySelectorAll('button.agt-link--dark');
    ...
    it('cycles through slides correctly', () => {
      ...
      const slides = block.querySelectorAll('.columns__slide');
      const nextButton = block.querySelectorAll('button.agt-link--dark')[1];
      const prevButton = block.querySelectorAll('button.agt-link--dark')[0];
